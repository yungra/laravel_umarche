        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    ...
                    <div class="mb-4 text-center">
                        <button data-micromodal-trigger="modal-1" href='javascript:;'
                            class="text-white border-0 py-2 px-6 focus:outline-none rounded"
                            style="background-color: rgb(156 163 175)"
                            onmouseover="this.style.background='rgb(107 114 128)'"
                            onmouseout="this.style.background='rgb(156 163 175)'">ショップの詳細を見る</button>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="modal__overlay z-50" tabindex="-1" data-micromodal-close>
            <div class="modal__container" role="dialog" aria-modal="true" aria-labelledby="modal-1-title">
                ...
                <footer class="modal__footer">
                    <button type="button" class="modal__btn test" data-micromodal-close
